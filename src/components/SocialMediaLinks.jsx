export default function SocialMediaLinks({
  ...
  return (
    ...
    >
      <span>
        <a
          href="https://www.linkedin.com/in/mehul-rathod-121405232/"
          target="new"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            className={`hover:scale-110 transition-hover duration-100 ${width} ${mobileWidth} ${color} ${
              darkMode
                ? `max-md:text-white hover:text-white`
                : `max-md:text-[#1788AE] ${hoverColor}`
            }`}
          >
            <path
              fill="currentColor"
      ...
      <span>
        <a href="https://x.com/MehulRathod_" target="new">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            className={`hover:scale-110 transition-hover duration-100 ${width} ${mobileWidth} ${color} ${
      ...
      <span>
        <a href="https://www.instagram.com/mehul_rathod135/" target="new">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            className={`hover:scale-110 transition-hover duration-100 ${width} ${mobileWidth} ${color} ${
      ...
      <span>
        <a href="https://t.me/cybermehul135" target="new">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            data-name="Layer 1"
            viewBox="0 0 24 24"
      ...
      <span>
        <a href="https://github.com/CyberMehul135" target="new">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
            className={`hover:scale-110 transition-hover duration-100 ${width} ${mobileWidth} ${color} ${
